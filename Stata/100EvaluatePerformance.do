...
*---------------------------------------------------------------------    
* performance (important models in main text
*---------------------------------------------------------------------

foreach sampletype in available similar {
    
	local thefile ${results}\\comparison_main_`sampletype'_${mrun}.tex 
	
	* see Utils.do measure_header code
	...
	* see Utils.do measure_footer code
